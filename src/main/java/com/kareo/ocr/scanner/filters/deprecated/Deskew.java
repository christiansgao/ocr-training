...
public class Deskew {
    ...
    */
    ...
    public static double findSkew(Mat mat) {
        final BufferedImage img = OCRHelper.matToBuf(mat);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Mat deskewed = deskew(img, skewness);
            System.out.println("skew: " + skewness);
            //skewness = findSkew(img);
            //System.out.println("skew: " + skewness);
            //deskewed = deskew(deskewed, skewness);
